...
int main(void)
{
	...
	while(1)                     //任务二  轮流点亮
  {
		...
		if (GPIOPinRead(GPIO_PORTJ_BASE,GPIO_PIN_0)	== 0) num+=1;     //按下为0
		Delay(500000); //防抖动
		if (num==5) num=1;
		switch (num){
			case(1):GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3,0x1);break;
			case(2):GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3,0x2);break;
			case(3):GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3,0x4);break;
			case(4):GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3,0x8);break;
