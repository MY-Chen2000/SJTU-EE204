...
int main(void)
{
  ...
  SysTickPeriodSet(ui32SysClock/SYSTICK_FREQUENCY);
   ...
   IntMasterEnable();		
	...
	if (GPIOPinRead(GPIO_PORTJ_BASE,GPIO_PIN_0)	== 0)	{num+=1;Delay(1000000);}
	if (num==3){num=0;}
	 ...
	 switch(num){
		 case(1):if (i2c_flash_cnt		>= 1) {i2c_flash_cnt				= 0;}          break;
		 case(2):if (i2c_flash_cnt		>= 5) {i2c_flash_cnt				= 0;}          break;
		 default: if (i2c_flash_cnt		>= 10) {i2c_flash_cnt				= 0;}          break;
