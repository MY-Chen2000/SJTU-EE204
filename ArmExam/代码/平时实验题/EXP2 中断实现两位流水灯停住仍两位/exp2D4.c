...
//分组显示：12——23——34——45——56——67——78——81——12的次序同时显示两位数字（称为组）的循环形式。组的循环放主程序中；组的动态刷新显示放在SysTick中断程序中
...
volatile uint8_t led_group_counter = 0, rightshift = 0x01, light=0x06;
//led_group_counter的取值为0或1，比如显示到“78”这一组，则当led_group_counter=0，显示7；=1，则显示8
...
void SysTick_Handler(void)
{
	...
	result 							= I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[(cnt+led_group_counter)%8+1]);	//write port 1 				
	result 							= I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,rightshift);	//write port 2
