...
int main(void)
{
	...
	while(1)
  {
		...
		if (read_key_value2	== 0)						//USR_SW1-PJ0 pressed
			Displaynum(517021);
     if (read_key_value	== 0)						//USR_SW1-PJ0 pressed
		 {
			Displayabc();
		 }
...
void Displayabc()
{
	...
	while(GPIOPinRead(GPIO_PORTJ_BASE,GPIO_PIN_0)==0){
		...
		/*Delay(100);
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[10]);
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,light);
	//I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,0);
	Delay(100);
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[11]);
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,light);
	//I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,0);
	Delay(100);
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[12]);
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,light);
	//I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,0);
	Delay(100);
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[13]);
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,light);
	//I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,0);
	Delay(100);
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[14]);
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,light);
	//I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,0);*/
	Delay(100);
	I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[14]);
	...
	//I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,0);
		...
		light=setbit(light,i);
		i=(i+1)%9;
		Delay(1000000);
	}
	I2C0_WriteByte(PCA9557_I2CADDR,PCA9557_OUTPUT,0xFF);
	result = I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,(uint8_t)(0x00));
}
